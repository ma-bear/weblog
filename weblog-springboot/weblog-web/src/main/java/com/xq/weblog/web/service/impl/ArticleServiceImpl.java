...
import com.xq.weblog.admin.event.ReadArticleEvent;
import com.xq.weblog.common.domain.dos.*;
import com.xq.weblog.common.domain.mapper.*;
import com.xq.weblog.common.enums.ResponseCodeEnum;
import com.xq.weblog.common.exception.BizException;
import com.xq.weblog.common.utils.PageResponse;
import com.xq.weblog.common.utils.Response;
import com.xq.weblog.web.convert.ArticleConvert;
import com.xq.weblog.web.markdown.MarkdownHelper;
...
import com.xq.weblog.web.model.vo.category.FindCategoryListRspVO;
import com.xq.weblog.web.model.vo.tag.FindTagListRspVO;
import com.xq.weblog.web.service.ArticleService;
import com.xq.weblog.web.utils.MarkdownStatsUtil;
import lombok.extern.slf4j.Slf4j;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.context.ApplicationEventPublisher;
import org.springframework.stereotype.Service;
import org.springframework.util.CollectionUtils;
import com.xq.weblog.web.model.vo.archive.FindArticleDetailRspVO;
...
public class ArticleServiceImpl implements ArticleService {
    ...
    public Response findArticlePageList(FindIndexArticlePageListReqVO findIndexArticlePageListReqVO) {
        ...
        // 第一步：分页查询文章主体记录
        Page<ArticleDO> articleDOPage = articleMapper.selectPageList(current, size, null, null, null, null, null);
